...
\Tina4\Post::add("signature/creator", function (\Tina4\Response $response, \Tina4\Request $request) {
            ...
            _td(
                _table(["width" => "100%", "cellpadding" => "0", "cellspacing" => "0"],
                    _tr(
                        ...
                        _p(["style" => "font-family: Arial, sans-serif; font-size: 16px; margin: 0; color: #000000; margin-top: 6px; margin-bottom: 4px;"],
                            $request->params["title"]
                        )
                    ),
                    _tr(
                        _td(
                            _img(["src" => "https://codeinfinity.co.za/images/c8-border-image.png", "alt" => "Divider Image"])
                        )
                    )
                )
            )
                    ...
                    _tr(
                        ...
                        _td(["style" => "padding-left: 15px;"],
                            _p(["style" => "font-family: Arial, sans-serif; font-size: 14px; margin: 0;"],
                                _a(["style" => "text-decoration: none; color: #000000", "href" => "mailto:" . $request->params["email"]], $request->params["email"])
                            )
                        )
                    )
                )
            ...
            _td(
                _table(["width" => "30", "cellpadding" => "0", "cellspacing" => "0"],
                    _tr(
                        ...
                        _td(["style" => "padding-left: 15px;"],
                            _p(["style" => "font-family: Arial, sans-serif; font-size: 14px; margin: 0;"],
                                _a(["style" => "text-decoration: none; color: #000000", "href" => "tel:" . $request->params["mobile"]], $request->params["mobile"])
                            )
                        )
                    )
                )
    ...
    $signature = _div(["style" => "background: #FFFFFF"], $signature,
        _table(["width" => "690", "cellpadding" => "0", "cellspacing" => "0"],
            _tr(
                _td(["style" => "border-top: 1px solid #d4d4d4; padding-top: 10px;"],
